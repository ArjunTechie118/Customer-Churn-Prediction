...
st.markdown(
    textwrap.dedent(
        ...
        .hero-badge{
            ...
            margin-bottom:18px;
            border-radius:999px;
            background:var(--hover-color,#e0f2fe);
            color:#2563eb;
            font-size:13px;
            font-weight:700;
        }
        ...
        .risk-card-header small{
            font-size:10px;
            color:#2563eb;
            background:var(--hover-color,#eff6ff);
            padding:6px 9px;
            border-radius:999px;
            white-space:nowrap;
        }
        ...
        .step-number{
            ...
            align-items:center;
            justify-content:center;
            background:var(--hover-color,#dbeafe);
            color:#2563eb;
            font-size:14px;
            font-weight:800;
        }
        ...
        .tech-item{
            text-align:center;
            padding:10px 18px;
            border-right:1px solid var(--border-color,#dbeafe);
        }
        ...
        .roadmap{
            ...
            padding:24px 28px;
            border-radius:12px;
            background:linear-gradient(120deg,#172f54,#10264a);
            color:#fff;
            display:grid;
        ...
        @media(max-width:700px){
            ...
            .tech-item{
                border-right:none;
                border-bottom:1px solid var(--border-color,#dbeafe);
            }
...
st.markdown(
    ...
    ChurnIQ helps you identify customers who are likely to churn using machine learning,
    so you can take action early and improve customer retention.
    </p>
    </div>
    ...
    * This is a sample result for demonstration purposes only.
    </div>
    </div>
    </div>
    </div>
...
st.markdown(
    ...
    <p>
    Predict the likelihood of customer churn using a trained machine learning model.
    </p>
    </div>
    ...
    <p>
    Convert model probability into clear risk levels for easier decision making.
    </p>
    </div>
    ...
    <p>
    Understand the key factors behind predictions using feature importance and planned SHAP analysis.
    </p>
...
st.markdown(
    ...
    <h3>Customer Data</h3>
    <p>
    You enter individual customer information through the application.
    </p>
    </div>
    ...
    <h3>FastAPI</h3>
    <p>
    The data is sent to the FastAPI backend for processing.
    </p>
    </div>
    ...
    <h3>LightGBM</h3>
    <p>
    The trained model predicts the customer's churn probability.
    </p>
    </div>
    ...
    <h3>Risk Result</h3>
    <p>
    You get a clear result with probability, risk level and future key factors.
    </p>
    </div>
...
st.markdown(
    ...
    <p>
    The next phase of ChurnIQ will integrate SHAP explainability,
    company policies and an LLM + RAG system to generate grounded
    ...
    <span class="roadmap-step-icon">📊</span>
    Churn Prediction
    </div>
...
st.markdown(
    ...
    <p>
    Explore the complete project, architecture, implementation and
...
st.markdown(
    """
    <div class="footer">
    ChurnIQ • AI-Powered Churn Intelligence • Machine Learning Project
    </div>
    """,
    unsafe_allow_html=True
)